...
This bridge was built in a single [Claude Cowork](https://claude.ai) session. Claude read through rvDNA's 4,679-line Rust codebase, identified the data format gap between continuous DNA sequences and sparse SNP genotyping, and wrote the Python adapter. The full story is on [Beyond Reason](https://beyondreason.substack.com/).
